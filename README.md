...
│   │   └── network_tester.py   # فاحص بورتات الشبكة المحيطة واختبار الخدمات المتوازي
...
│   └── tabs/                   # تبويبات الأدوات (11 ملف تبويب مستقل)
│       ├── __init__.py
...
│       └── net_tester_tab.py   # تبويب فاحص بورتات وأجهزة الشبكة الشامل
│
